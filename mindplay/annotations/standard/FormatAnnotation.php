...
{
    /**
     * @var string A formatting string compatible with sprintf()
     * @link http://php.net/sprintf
     */
    public $format;

    /**
     * @var string String to be used in place of an empty property value.
     */
    public $default;

    /**
     * @var array|string Standard PHP callback array (class name|object, method name) or function name.
