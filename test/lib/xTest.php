...
abstract class xTest
{
   ...
   *
   * @param $result string Optional - if supplied, should contain a brief description of why the test failed
   */
   ...
   *
   * @param $pass bool If this expression evaluates as true, the test is passed
   * @param $fail string Optional - if supplied, should contain a brief description of why the test failed
   */
   ...
   *
   * @param $a mixed Any value
   * @param $b mixed Any value - if exactly the same as $a, the test is passed
   * @param $fail string Optional - if supplied, should contain a brief description of why the test failed
   */
